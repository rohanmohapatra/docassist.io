...
class EditCompletedDoc extends Component{
  constructor(props){
    super(props);
    this.state = {
      html : "",
  ...
  componentWillMount(){
    ...
    const fetchData = async () => {
      ...
      var apiBaseUrl = '/api/media/'+this.name+'/edit/';
      ...
      <div className={classes.root}>
        ...
        >
          ...
          >
            ...
            {this.state.status &&<Editor placeholder={'Write something...'} editedHtml={this.state.html} callbackFromParent={this.myCallback} generatedId={this.name}/>}
...
export default withStyles(styles)(EditCompletedDoc);
