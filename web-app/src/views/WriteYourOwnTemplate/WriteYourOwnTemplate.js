...
class WriteYourOwnTemplate extends Component{
  constructor(props){
    super(props);
    this.state = {
      html : "",
      ...
      <div className={classes.root}>
        ...
        >
          ...
          >
            ...
            <Editor placeholder={'Start creating Template .. '} editedHtml={this.state.html} sendHtmlToParent={this.editorHtml} templateId={this.name}/>
...
export default withStyles(styles)(WriteYourOwnTemplate);
